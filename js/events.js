...
function eventsHover() {
 ...
 document.getElementById("radioDetails").style.cursor = "pointer";
document.getElementById("320Details").style.cursor = "pointer";
document.getElementById("secretDetails").style.cursor = "pointer";
document.getElementById("whitneyDetails").style.cursor = "pointer";
}
